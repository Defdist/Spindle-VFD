...
#define ADC_CHANNEL_cur_phaseA // ADC6 PB5 (ADMUX bxxx00110)
#define ADC_CHANNEL_cur_phaseB // ADC9 PC5 (ADMUX bxxx01001)
#define ADC_CHANNEL_cur_phaseC // ADC8 PC4 (ADMUX bxxx01000)
