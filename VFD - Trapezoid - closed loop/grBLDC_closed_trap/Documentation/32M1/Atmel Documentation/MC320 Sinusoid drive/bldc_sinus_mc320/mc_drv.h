//!
//! @file $RCSfile: mc_drv.h,v $
//!
//! Copyright (c) 2006 Atmel.
//!
//! @brief Header of Hardware Level of the Motor Control
//!
...
#define _MC_DRV_H_
 ...
 // #define Set_none() (TCCR1A=output_disconnected,TCCR3B=output_disconnected)
  ...
  /* with back_emf signals */
  #define HALL_SENSOR_VALUE() (ACSR & 0x07)
#else
  /* with hall sensor inputs */
...
#define MIN_DELAY 2
#define MAX_DELAY 40
#define FILTER_DELAY 4   //! parasitic delay due to external filter
#define MASK_DEMAG 2 //! delay to mask demagnetization time
