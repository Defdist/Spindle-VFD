...
//!
//! @version $Revision: 1.7 $ $Name: mc100_bldc_sinus_1_0_0 $
//!
//! @todo
//! @bug
...
#define Enable_psc2_end_of_cycle_interrupt()          (PIM2 |=  (1<<PEOPE2) )     //!< An interrupt is generated when PSC2 reaches the end of the whole cycle
#define Disable_psc2_end_of_cycle_interrupt()         (PIM2 &= ~(1<<PEOPE2) )     //!< No interrupt is generated when PSC2 reaches the end of the whole cycle
      //! @}
