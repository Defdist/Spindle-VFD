...
Boolean mci_direction = CW; //!<User Input parameter to set motor direction
Boolean mci_run_stop = 0;    //!<User Input parameter to launch or stop the motor
uint8_t mci_ref_speed = 0;        //!<User Input parameter to set motor speed

uint8_t mci_measured_speed = 0;   //!<Motor Input parameter to get the motor speed
